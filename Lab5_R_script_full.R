...
g1 <- g1 + geom_abline(intercept = m1$coefficients[1], slope = m1$coefficients[3], 
                     color = "grey", size = 1, alpha = 0.5)
g1 <- g1 + geom_abline(intercept = m1$coefficients[1]+m1$coefficients[2],
                     slope = m1$coefficients[3], color = "cornflowerblue",size = 1, alpha = 0.5)
...
g2 <- g2 + geom_abline(intercept = m22$coefficients[1], slope = m22$coefficients[3], 
                     color = "grey", size = 1, alpha = 0.5)
g2 <- g2 + geom_abline(intercept = m22$coefficients[1]+m22$coefficients[2],
                     slope = m22$coefficients[3] + m22$coefficients[4], color = "cornflowerblue",size = 1, alpha = 0.5)
