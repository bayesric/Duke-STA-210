...
housing <- housing[,c(1,11,14)]
names(housing) <- c("CRIM","PTRATIO","MEDV")
#******************************************************
...
text(housing$CRIM[381], housing$MEDV[381], labels="381", cex= 0.7, pos=3)
plot(housing$PTRATIO,housing$MEDV)
text(housing$PTRATIO[381], housing$MEDV[381], labels="381", cex= 0.7, pos=3)
lm2 <- lm(log(MEDV)~.,data=housing[-381,])
summary(lm2)
#******************************************************
